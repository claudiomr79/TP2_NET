...
namespace Data.Database
{
    public class UsuarioAdapter:Adapter
    {
        ...
        protected void Update (Usuario usuario)
        {
            ...
            {
                Exception ExcepcionManejada = new Exception("Error al modificar datos del usuario"+ Ex.Message);
                throw ExcepcionManejada;
            }
            finally
            {
        ...
        protected void Insert (Usuario usuario)
        {
            ...
            {
                Exception ExcepcionManejada = new Exception("Error al crear usuario" +  Ex.Message);
                throw ExcepcionManejada;
            }
            finally
            {
